...
app_settings = {
    ...
    "INFOPLIST_KEY_NSDesktopFolderUsageDescription":
        "Raptor Cleanse needs access to your Desktop to list the files you asked it to review or scan.",
    "INFOPLIST_KEY_NSDocumentsFolderUsageDescription":
        "Raptor Cleanse needs access to your Documents folder to list the files you asked it to review or scan.",
    "INFOPLIST_KEY_NSDownloadsFolderUsageDescription":
        "Raptor Cleanse needs access to your Downloads folder to list the files you asked it to review or scan.",
    "INFOPLIST_KEY_NSRemovableVolumesUsageDescription":
        "Raptor Cleanse needs access to removable volumes only if you choose a folder on one.",
    "MARKETING_VERSION": "0.4.1", "CURRENT_PROJECT_VERSION": "6",
