...
function zonePosition(){if(circuitProgress(levelIndex)<2/3)return{x:0,z:0};const n=Math.floor(time/45)%3;return n===0?{x:0,z:0}:map.toWorld(n===1?3:map.n-4,Math.floor(map.n/2));}
