...
export const SOUND_TYPES=new Set(['boost_run','boost_fire','boost_jump','weaponPickup','weaponDrop','shot_throw','shot_spud','shot_repeater','shot_scatter','shot_masher','shot_rpg','explosion','hit','catch','dash','jump','land','step','crouch','duckGate','checkpoint','pickup','win','impact']);
